...
const eyeIcons = document.querySelectorAll('.show-eye img');
...
function showPassword(inputField, eyeIcon){
    ...
    eyeIcon.src ='./img/eye-splash.png';
}else{
    inputField.setAttribute('type', 'password');
    eyeIcon.src='./img/eye2-splash.png';
}
}
...
try{
    ...
    console.log('error registring a user', err);
}
